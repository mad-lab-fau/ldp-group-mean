...
def plot_mean_nprr_summary(df_grouped, output_dir, error=None):
...
def plot_mean_nprr(df_grouped, output_dir, error=None):
    if not output_dir.exists():
        output_dir.mkdir(parents=True)
...
if __name__ == "__main__":
    ...
    df_grouped = _read_all_pkls("group_mean_nprr_fixed")

    output_dir = Path("plots_paper") / "group_mean_nprr"
    output_dir.mkdir(parents=True, exist_ok=True)

    plot_mean_nprr_summary(df_grouped, output_dir)
    plot_mean_nprr(df_grouped, output_dir)

    plot_mean_nprr_summary(df_grouped, output_dir, "total_group_error_ratio")
    plot_mean_nprr(df_grouped, output_dir, "total_group_error_ratio")
